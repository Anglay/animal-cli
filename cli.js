...
const inquirer = require('inquirer')// 命令行交互使用`inquirer`模块，这里要单独安装一下这个模块
const figlet = require('figlet');// console.log出一个漂亮的大logo
...
inquirer.prompt([
    ...
    download('direct:https://github.com/Anglay/animal-cli.git#main', downloadPath, { clone: true }, function (err) {
        if (err) {
